defmodule Garuda.Framework.GameChannel do
  ...
  @callback on_leave(reason :: :normal | :shutdown | {:shutdown, :left | :closed | term()}, socket :: Phoenix.Socket) :: any()
  defmacro __using__(_opts \\ []) do
    quote do
      ...
      def handle_info({"after_join", params}, socket) do
        RoomSheduler.create_room(socket.assigns.game_room_module, socket.assigns.garuda_game_room_id, game_room_id: socket.assigns.garuda_game_room_id)
